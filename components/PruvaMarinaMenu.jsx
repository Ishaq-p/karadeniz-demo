...
const ITEMS = [
  // Kahvaltı
  { id: "serpme", category: "kahvalti", price: 420, kcal: 850, tags: ["popular", "chef"], img: img(2741458), allergens: ["dairy","egg","gluten"], ingredients: [{n:"Peynir çeşitleri",a:"100 g"},{n:"Yumurta",a:"2 adet"},{n:"Bal & kaymak",a:"40 g"},{n:"Zeytin",a:"30 g"},{n:"Domates/salatalık",a:"80 g"}], name:{tr:"Pruva Serpme Kahvaltısı",en:"Pruva Spread Breakfast"}, desc:{tr:"Deniz manzarasında, nefis çeşitlerle serpme kahvaltı.",en:"Spread breakfast with delicious variety, overlooking the sea."} },
  { id: "omlet", category: "kahvalti", price: 220, kcal: 380, tags: ["popular","veg"], img: img(2741458), allergens: ["egg","dairy"], ingredients: [{n:"Yumurta",a:"3 adet"},{n:"Mantar & peynir",a:"60 g"},{n:"Tereyağı",a:"15 g"}], name:{tr:"Mantarlı Omlet",en:"Mushroom Omelette"}, desc:{tr:"Mantar ve peynirle dolu yumuşak omlet.",en:"Soft omelette filled with mushrooms and cheese."} },
  // Kahvaltı Extra
  { id: "bal_kaymak", category: "kahvaltiExtra", price: 120, kcal: 280, tags: ["popular","veg"], img: img(2741458), allergens: ["dairy"], ingredients: [{n:"Organik bal",a:"40 g"},{n:"Kaymak",a:"50 g"}], name:{tr:"Bal & Kaymak",en:"Honey & Clotted Cream"}, desc:{tr:"Organik çiçek balı ve taze kaymak.",en:"Organic wildflower honey and fresh clotted cream."} },
  // Kapalı Pideler
  ...
  { id: "levrek", category: "deniz", price: 520, kcal: 420, tags: ["light","chef"], img: img(2741458), allergens: ["fish"], ingredients: [{n:"Levrek fileto",a:"280 g"},{n:"Zeytinyağı",a:"15 ml"},{n:"Mevsim yeşillik",a:"50 g"}], name:{tr:"Izgara Levrek",en:"Grilled Sea Bass"}, desc:{tr:"Deniz manzarasında ızgara taze levrek.",en:"Fresh grilled sea bass with a sea view."} },
  ...
  // Tatlılar
  { id: "kuzu_kulagi", category: "tatli", price: 200, kcal: 480, tags: ["popular","veg","chef"], img: img(312418), allergens: ["dairy","gluten","egg"], ingredients: [{n:"Kuzu kulağı hamuru",a:"100 g"},{n:"Kaymak",a:"50 g"},{n:"Şerbet",a:"40 ml"},{n:"Antep fıstığı",a:"10 g"}], name:{tr:"Kuzu Kulağı",en:"Kuzu Kulağı"}, desc:{tr:"Geleneksel Türk tatlısı, kaymak ve fıstıkla.",en:"Traditional Turkish pastry with clotted cream and pistachios."} },
  { id: "sutlac", category: "tatli", price: 150, kcal: 300, tags: ["veg","popular"], img: img(312418), allergens: ["dairy"], ingredients: [{n:"Süt",a:"250 ml"},{n:"Pirinç",a:"40 g"},{n:"Şeker",a:"30 g"}], name:{tr:"Fırın Sütlaç",en:"Baked Rice Pudding"}, desc:{tr:"Fırında pişirilmiş karamelize sütlaç.",en:"Baked rice pudding with caramelized top."} },
  // İçecekler
