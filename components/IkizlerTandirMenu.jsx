...
const ITEMS = [
    ...
    { id: "tavuk_corba", category: "corba", price: 100, kcal: 160, tags: ["light"], img: img(3551324), allergens: [], ingredients: [{ n: "Tavuk suyu", a: "250 ml" }, { n: "Pirinç", a: "30 g" }, { n: "Maydanoz", a: "5 g" }], name: { tr: "Tavuk Suyu Çorbası", en: "Chicken Broth Soup" }, desc: { tr: "Hafif ve besleyici tavuk suyu çorbası.", en: "Light and nourishing chicken broth soup." } },
    { id: "paca", category: "corba", price: 120, kcal: 240, tags: ["popular"], img: img(5409587), allergens: [], ingredients: [{ n: "Kuzu paçası", a: "150 g" }, { n: "Sarımsak", a: "5 g" }, { n: "Sirke", a: "servis ile" }], name: { tr: "Paça Çorbası", en: "Trotter Soup" }, desc: { tr: "Geleneksel kuzu paça çorbası, sarımsak ve sirke ile.", en: "Traditional lamb trotter soup served with garlic and vinegar." } },
    // Tandırlar
    ...
    // Yemekler
    { id: "kuru_fasulye", category: "yemek", price: 150, kcal: 380, tags: ["veg", "popular"], img: img(5409587), allergens: [], ingredients: [{ n: "Kuru fasulye", a: "200 g" }, { n: "Domates sos", a: "80 g" }, { n: "Soğan", a: "40 g" }], name: { tr: "Kuru Fasulye", en: "White Bean Stew" }, desc: { tr: "Geleneksel domates soslu kuru fasulye.", en: "Traditional white bean stew in tomato sauce." } },
    ...
    { id: "cay", category: "icecek", price: 40, kcal: 5, tags: ["veg", "light"], img: img(3551324), allergens: [], ingredients: [{ n: "Çay", a: "1 demleme" }], name: { tr: "Çay", en: "Turkish Tea" }, desc: { tr: "Geleneksel Türk çayı.", en: "Traditional Turkish tea." } },
